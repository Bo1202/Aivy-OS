...
## v2.0 更新（2026-04-28 · 视觉系统升级 + IDE 三栏）
...
| 安装包 | 250 MB | **473 MB**（含完整 chromium / Monaco / Skills + v2.0.1 文档处理 ML 库）|

完整清单见 [Release Notes v2.0](https://github.com/Bo1202/Aivy-OS/releases/tag/v2.0.0)。
